...
class Pages
{
	...
	*/
	...
	{
		$css = LWS_ADMIN_PANEL_CSS . '/lws_icons.css';
		wp_enqueue_style('lws-adminpanel-icons', $css, array(), LWS_ADMIN_PANEL_VERSION);
		$css = LWS_ADMIN_PANEL_CSS . '/style.css';
		wp_enqueue_style('lws-adminpanel-css', $css, array(), LWS_ADMIN_PANEL_VERSION);

		if( $this->isOurPage(self::currentPage()) )
		{
			$css = LWS_ADMIN_PANEL_CSS . '/wp.css';
			wp_enqueue_style('lws-adminpanel-wpcss', $css, array(), LWS_ADMIN_PANEL_VERSION);
			$css = LWS_ADMIN_PANEL_CSS . '/pseudocss.css';
			wp_enqueue_style('lws-adminpanel-pseudocss', $css, array('lws-adminpanel-css'), LWS_ADMIN_PANEL_VERSION);
			$css = LWS_ADMIN_PANEL_CSS . '/colorselector.css';
			wp_enqueue_style('lws-adminpanel-colorselector', $css, array('lws-adminpanel-css'), LWS_ADMIN_PANEL_VERSION);
			$css = LWS_ADMIN_PANEL_CSS . '/fontselector.css';
			wp_enqueue_style('lws-adminpanel-fontselector', $css, array('lws-adminpanel-css'), LWS_ADMIN_PANEL_VERSION);
			$css = LWS_ADMIN_PANEL_CSS . '/stygen.css';
			wp_enqueue_style('lws-adminpanel-stygen', $css, array('lws-adminpanel-css'), LWS_ADMIN_PANEL_VERSION);
			wp_enqueue_media();
		}
	}
	...
	public function enqueueScripts($scriptFilters=array())
	{
		...
		if( empty($todo) || isset($todo['lws-adminpanel-editlist']) )
			$this->enqueueScript( 'lws-adminpanel-editlist', '/editlist.js', array('lws-tools', 'lws-base64', 'jquery', 'jquery-ui-dialog'), true, array('confirmLeave' => __("Confirm or abort edition before continue.", 'lws-adminpanel')), 'lws_editlist' );
		...
		if( empty($todo) || isset($todo['lws-adminpanel-fields']) )
		{
			...
			$this->enqueueScript( 'lws-adminpanel-fields', '/fields.js', array('lws-tools', 'lws-base64', 'jquery', 'jquery-ui-autocomplete'), true,
				array(
					...
					'fontToggleMore' => __("Show more", "Font list", 'lws-adminpanel'),
					'fontToggleLess' => __("Show less", "Font list", 'lws-adminpanel'),
					'fontWeightTr' => array(
