...
class LacChecklist extends \LWS\Adminpanel\Pages\LAC
{
	...
	public function script()
	{
		...
		wp_enqueue_script( 'lac-checklist', LWS_ADMIN_PANEL_JS . '/lac/lacchecklist.js', $dep, LWS_ADMIN_PANEL_VERSION, true );
		$css = LWS_ADMIN_PANEL_CSS . '/lac/lacchecklist.css';
		wp_enqueue_style('lws-adminpanel-lacchecklistcss', $css, array('lws-adminpanel-css'), LWS_ADMIN_PANEL_VERSION);
	}
